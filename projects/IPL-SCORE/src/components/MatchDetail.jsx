...
function MatchDetail() {
    ...
    // Fixed Dummy Data {not of IPL-2026}
    let fixedData = {
        matchInfo: {
            matchId: 91596,
    ...
    async function FetchMatchDetail() {
        ...
        // const url = `https://cricbuzz-cricket.p.rapidapi.com/mcenter/v1/155409`;
        const options = {
            method: "GET",
            headers: {
                "X-RapidAPI-Key":
    ...
    return (
        <div>
            <h1 className='text-xl text-center p-5'>Match Details</h1>
            {
                fixedData.length <= 0 ?
                    (<h1>Loading...</h1>) :
                    (<InPageNavigation
                        teams={[fixedData.matchInfo.team1.shortName,
...

                        {
                            ...
                            (<div key={i} className='p-3'>
                                ...
                                <h3 className='text-md text-white/50'>{data.role}</h3>
                            </div>)
                            )
                        }
                        {
